...
{ if (((l) < 0) || ((l) > LP_MAX_BUF)) { \
	...
	for (;;) {
		...
		case 'b':
			...
			length =
			    user_PrintNum(buf, num, 2, 0, width, ladjust, padc,
					  0);
		...
		case 'D':
			...
			length =
			    user_PrintNum(buf, num, 10, negFlag, width, ladjust,
					  padc, 0);
			OUTPUT(arg, buf, length);
			break;
		...
		case 'O':
			...
			length =
			    user_PrintNum(buf, num, 8, 0, width, ladjust, padc,
					  0);
			OUTPUT(arg, buf, length);
			break;
		...
		case 'U':
			...
			length =
			    user_PrintNum(buf, num, 10, 0, width, ladjust, padc,
					  0);
			OUTPUT(arg, buf, length);
			break;
		...
		case 'x':
			...
			length =
			    user_PrintNum(buf, num, 16, 0, width, ladjust, padc,
					  0);
			OUTPUT(arg, buf, length);
			break;
